...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QIcon()
        icon.addFile(
            u":/images/images/images/Polaris.png",
            QSize(),
            QIcon.Normal,
            QIcon.Off)
        ...
        self.bg2.setStyleSheet(
            u"border-top-right-radius: 20px;\n"
            "background-color: rgba(40, 27, 40, 150);\n"
        ...
        self.icon_1.setPixmap(
            QPixmap(u":/icons/images/icons/home_selected.png"))
        ...
        self.btn_documentation.setStyleSheet(
            u"#btn_documentation {\n"
            "background-color: transparent;\n"
            "font: 600 10pt \"Inter Medium\";\n"
            "text-align: left;\n"
        ...
        self.icon_2.setPixmap(
            QPixmap(u":/icons/images/icons/edit_unselected.png"))
        ...
        self.sep2.setPixmap(
            QPixmap(u":/icons/images/icons/separator_inactive.png"))
        ...
        self.currentlyloggedin.setStyleSheet(
            u"border: none;\n"
            "background-color: transparent;\n"
            "font: 600 10pt \"Inter Medium\";\n"
            "text-align: left;\n"
        ...
        self.creditsLabel_2.setStyleSheet(u"background-color: transparent;\n"
                                          ...
                                          "text-align: left;")
        self.creditsLabel_2.setAlignment(
            Qt.AlignLeading | Qt.AlignLeft | Qt.AlignVCenter)
        ...
        icon1 = QIcon()
        icon1.addFile(
            u":/icons/images/icons/arrow-down-left.png",
            QSize(),
            QIcon.Normal,
            QIcon.Off)
        ...
        self.btn_addfirsthsm.setStyleSheet(
            u"#btn_addfirsthsm {\n"
        ...
        icon2 = QIcon()
        icon2.addFile(
            u":/icons/images/icons/cil-plus.png",
            QSize(),
            QIcon.Normal,
            QIcon.Off)
        ...
        self.hsmmasterpassword = QLabel(self.hsmdetails)
        self.hsmmasterpassword.setObjectName(u"hsmmasterpassword")
        self.hsmmasterpassword.setGeometry(QRect(340, 201, 111, 31))
        self.hsmmasterpassword.setStyleSheet(
            u"font: 600 10pt \"Inter Medium\";")
        ...
        self.hsm_masterpw.setStyleSheet(
            u"background: solid rgb(16, 11, 16);\n"
            "border: 2px solid rgb(157, 122, 222);\n"
            "border-radius: 15px;\n"
            "font: 600 10pt \"Inter Medium\";\n"
            "color: white;")
        self.hsm_machineid = QLineEdit(self.hsmdetails)
        self.hsm_machineid.setObjectName(u"hsm_machineid")
        self.hsm_machineid.setGeometry(QRect(330, 303, 271, 30))
        self.hsm_machineid.setMinimumSize(QSize(0, 30))
        self.hsm_machineid.setStyleSheet(
            u"background: solid rgb(16, 11, 16);\n"
            "border: 2px solid rgb(157, 122, 222);\n"
            "border-radius: 15px;\n"
            "font: 600 10pt \"Inter Medium\";\n"
            "color: white;")
        self.hsm_machineid.setReadOnly(True)
        self.hsmmachineid = QLabel(self.hsmdetails)
        self.hsmmachineid.setObjectName(u"hsmmachineid")
        self.hsmmachineid.setGeometry(QRect(340, 272, 151, 31))
        self.hsmmachineid.setStyleSheet(u"font: 600 10pt \"Inter Medium\";")
        ...
        self.add_button.setStyleSheet(
            ...
            "}")
        icon3 = QIcon()
        icon3.addFile(u":/icons/images/icons/plus.png",
        ...
        self.hsmlist_bg.setStyleSheet(
            u"background-color: qlineargradient(spread:pad, x1:0.494, y1:0, x2:0.494, y2:1, stop:0 rgba(0, 9, 31, 100), stop:1 rgba(157, 122, 222, 80));")
        ...
        self.btn_controlpanel.setStyleSheet(
            u"#btn_controlpanel {\n"
            "background-color: transparent;\n"
            "font: 600 10pt \"Inter Medium\";\n"
            "text-align: center;\n"
        ...
        self.controlpanel_bg.setStyleSheet(
            u"background-color: qlineargradient(spread:pad, x1:0.494, y1:0, x2:0.494, y2:1, stop:0 rgba(0, 9, 31, 100), stop:1 rgba(157, 122, 222, 80));")
        ...
        self.btn_configurator.setStyleSheet(
            u"#btn_configurator {\n"
            "background-color: transparent;\n"
            "font: 600 10pt \"Inter Medium\";\n"
            "text-align: center;\n"
        ...
        self.configurator_bg.setStyleSheet(
            u"background-color: qlineargradient(spread:pad, x1:0.494, y1:0, x2:0.494, y2:1, stop:0 rgba(0, 9, 31, 100), stop:1 rgba(157, 122, 222, 80));")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_documentation.setText(
            QCoreApplication.translate(
                "MainWindow", u"  Documentation", None))
        self.icon_2.setText("")
        self.sep2.setText("")
        self.sep3.setText("")
        self.icon_3.setText("")
...
# if QT_CONFIG(tooltip)
        self.username.setToolTip(
            QCoreApplication.translate(
                "MainWindow",
                u"<html><head/><body><p>Go to web dashboard</p></body></html>",
                None))
# endif // QT_CONFIG(tooltip)
        self.username.setText(
            QCoreApplication.translate(
                "MainWindow", u"Username", None))
        self.currentlyloggedin.setText(
            QCoreApplication.translate(
                "MainWindow",
                u"Currently Logged In At",
                None))
        self.ipaddress.setText(
            QCoreApplication.translate(
                "MainWindow", u"8.8.8.8", None))
# if QT_CONFIG(tooltip)
        self.btn_website.setToolTip(
            QCoreApplication.translate(
                "MainWindow",
                u"<html><head/><body><p>Log out</p></body></html>",
                None))
# endif // QT_CONFIG(tooltip)
        ...
        self.creditsLabel.setText(
            QCoreApplication.translate(
                ...
                u"Milestone 4 Build",
                None))
        self.creditsLabel_2.setText(
            QCoreApplication.translate(
                "MainWindow", u"0.3.0", None))
        self.btn_dropdown.setText("")
        self.btn_addfirsthsm.setText(
            QCoreApplication.translate(
                "MainWindow", u"Add your first HSM", None))
        self.hsm_name.setText("")
        self.hsm_name.setPlaceholderText(
            QCoreApplication.translate(
                "MainWindow",
                u"Give your HSM a label...",
                None))
        self.hsmnamelabel.setText(
            QCoreApplication.translate(
                "MainWindow", u"HSM Name", None))
        self.addhsmtitle.setText(
            QCoreApplication.translate(
                "MainWindow", u"Add your HSM", None))
        self.hsmmasterpassword.setText(
            QCoreApplication.translate(
                "MainWindow", u"Master Password", None))
        self.hsm_masterpw.setText("")
        self.hsm_masterpw.setPlaceholderText(
            QCoreApplication.translate(
                "MainWindow", u"Enter a master password...", None))
        self.hsm_machineid.setText("")
        self.hsm_machineid.setPlaceholderText("")
        self.hsmmachineid.setText(
            QCoreApplication.translate(
                "MainWindow",
                u"Your Machine Identifier",
                None))
        self.hsm_ip.setText("")
        self.hsm_ip.setPlaceholderText(QCoreApplication.translate(
            "MainWindow", u"Enter the HSM's IP address...", None))
        self.hsmiplabel.setText(
            QCoreApplication.translate(
                "MainWindow", u"HSM IP Address", None))
        self.add_button.setText(
            QCoreApplication.translate(
                "MainWindow", u" Add", None))
        self.btn_hsmlist.setText(
            QCoreApplication.translate(
                "MainWindow", u"Overview", None))
        self.hsmlist_bg.setText("")
        self.btn_controlpanel.setText(
            QCoreApplication.translate(
                "MainWindow", u"Control Panel", None))
        self.controlpanel_bg.setText("")
        self.btn_configurator.setText(
            QCoreApplication.translate(
                "MainWindow", u"Configurator", None))
